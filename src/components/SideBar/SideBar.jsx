        ...
        <div className='mt-4'>
          ...
          <ul className='nav nav-pills flex-column mt-2 mt-sm-0' id='secret-menu'>
            <li className='nav-item my-sm-1 my-2'>
              <a to='/secret/add-product' className='nav-link text-white text-center text-sm-start' aria-current='page'>
                <i className='fa-solid fa-gauge' />
                <span className='ms-2 d-none d-sm-inline'>Crear producto</span>
              </a>
            </li>
            <li className='nav-item my-sm-1 my-2'>
              <a to='/secret/edit-product' className='nav-link text-white text-center text-sm-start' aria-current='page'>
                <i className='fa fa-house' />
                <span className='ms-2 d-none d-sm-inline'>Editar un producto</span>
              </a>
            </li>
            <li className='nav-item my-sm-1 my-2'>
              <a to='/secret/delete-product' className='nav-link text-white text-center text-sm-start' aria-current='page'>
